  ...
  return (
    <>
      <section
        ...
        data-oid="b:jeshj"
      >
        <div className="container py-16 lg:py-24" data-oid="qsgu8o5">
          <div
        ...
        <div data-oid="rsvckz5">
          <span className="absolute left-0 top-0 z-[-1]" data-oid="_3nantu">
            <svg
              width="287"
              height="254"
              viewBox="0 0 287 254"
            ...
            >
              ...
              <defs data-oid="-yk7xtk">
                <linearGradient
                  ...
                  data-oid="tik2phj"
                >
                  <stop stopColor="#4A6CF7" data-oid="07d8h-y" />
                  <stop
                    offset="1"
                    stopColor="#4A6CF7"
                    stopOpacity="0"
          ...
          <span className="absolute right-0 top-0 z-[-1]" data-oid="lnn99qz">
            <svg
              width="628"
              height="258"
              viewBox="0 0 628 258"
            ...
            >
              ...
              <defs data-oid="_kjte4j">
                <linearGradient
                  ...
                  data-oid="k29p.5u"
                >
                  <stop stopColor="#4A6CF7" data-oid="pt_uoii" />
                  <stop
                    offset="1"
                    stopColor="#4A6CF7"
                    stopOpacity="0"
                ...
                <linearGradient
                  ...
                  data-oid="lzs1b0v"
                >
                  <stop stopColor="#4A6CF7" data-oid="7i10gz:" />
                  <stop
                    offset="1"
                    stopColor="#4A6CF7"
                    stopOpacity="0"
