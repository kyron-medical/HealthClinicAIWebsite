const PricingBox = (props: {
  ...
  return (
    <div className="w-full" data-oid="pydeqqn">
      <div
        ...
        data-oid="nf9p1ed"
      >
        <div className="flex items-center justify-between" data-oid="_my7iz9">
          <h3
            className="price mb-2 text-[32px] font-bold text-black dark:text-white"
            data-oid="l9fhv-g"
          >
            $
            <span className="amount" data-oid="wm:yeam">
              {price}
            </span>
            <span
        ...
        <p className="mb-7 text-base text-body-color" data-oid="ialycxm">
          {subtitle}
        </p>
        <div
        ...
        <div data-oid="0rpcrt2">{children}</div>
        <div className="absolute bottom-0 right-0 z-[-1]" data-oid="hgnpvyr">
          <svg
            width="179"
            height="158"
            viewBox="0 0 179 158"
