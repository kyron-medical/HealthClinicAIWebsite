const PricingBox = (props: {
  ...
  return (
    <div className="w-full" data-oid="bhqlbw9">
      <div
        ...
        data-oid="g9f2y.1"
      >
        <div className="flex items-center justify-between" data-oid="i:0o95f">
          <h3
            className="price mb-2 text-[32px] font-bold text-black dark:text-white"
            data-oid="pyx8opr"
          >
            $
            <span className="amount" data-oid="k9nyvr2">
              {price}
            </span>
            <span
        ...
        <p className="mb-7 text-base text-body-color" data-oid="da0biyf">
          {subtitle}
        </p>
        <div
        ...
        <div data-oid="v-ij_h.">{children}</div>
        <div className="absolute bottom-0 right-0 z-[-1]" data-oid="6agnna.">
          <svg
            width="179"
            height="158"
            viewBox="0 0 179 158"
