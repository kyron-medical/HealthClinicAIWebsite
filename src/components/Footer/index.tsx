  ...
  return (
    <>
      <footer
        ...
        data-oid="d42cuug"
      >
        <div className="container mx-auto px-4" data-oid="r7.ymn7">
          <div className="-mx-4 flex flex-wrap" data-oid="qi70455">
            <div
              className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12"
              data-oid="l7-3t.o"
            >
              <div className="mb-12 max-w-[360px] lg:mb-16" data-oid="8yc3a6:">
                <Link
                  href="/"
            ...
            <div
              ...
              data-oid="tft.nx9"
            >
              <div className="mb-12 lg:mb-16" data-oid="m2u2evs">
                <h2
            ...
            <div
              ...
              data-oid="f3gijdb"
            >
              <div className="mb-12 lg:mb-16" data-oid="_crpd7i">
                <h2
                  className="mb-10 text-xl font-bold text-black dark:text-white"
                  data-oid="vy5al1x"
                >
