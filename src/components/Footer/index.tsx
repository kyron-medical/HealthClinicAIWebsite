  ...
  return (
    <>
      <footer
        ...
        data-oid="rqe9k_l"
      >
        <div className="container mx-auto px-4" data-oid="-fm6_qz">
          <div className="-mx-4 flex flex-wrap" data-oid="2mvlu69">
            <div
              className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12"
              data-oid="ub6qume"
            >
              <div className="mb-12 max-w-[360px] lg:mb-16" data-oid="1vo28gw">
                <Link
                  href="/"
            ...
            <div
              ...
              data-oid="6xhi:io"
            >
              <div className="mb-12 lg:mb-16" data-oid="edphs.o">
                <h2
            ...
            <div
              ...
              data-oid="-piy2q:"
            >
              <div className="mb-12 lg:mb-16" data-oid="7d-167r">
                <h2
                  className="mb-10 text-xl font-bold text-black dark:text-white"
                  data-oid="8ah8oke"
                >
