  ...
  return (
    <>
      <footer
        ...
        data-oid="nwgz:zi"
      >
        <div className="container mx-auto px-4" data-oid="27k15uf">
          <div className="-mx-4 flex flex-wrap" data-oid="ne0ojc7">
            <div
              className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12"
              data-oid="1kfdjkx"
            >
              <div className="mb-12 max-w-[360px] lg:mb-16" data-oid="th2yaec">
                <Link
                  href="/"
            ...
            <div
              ...
              data-oid="gzsoakn"
            >
              <div className="mb-12 lg:mb-16" data-oid="3vlpkyx">
                <h2
            ...
            <div
              ...
              data-oid="a62_8:b"
            >
              <div className="mb-12 lg:mb-16" data-oid="y9r997d">
                <h2
                  className="mb-10 text-xl font-bold text-black dark:text-white"
                  data-oid="qfruozf"
                >
