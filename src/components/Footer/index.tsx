  ...
  return (
    <>
      <footer
        ...
        data-oid="hj5xyj4"
      >
        <div className="container mx-auto px-4" data-oid="abt4mpk">
          <div className="-mx-4 flex flex-wrap" data-oid="j9:8bse">
            <div
              className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12"
              data-oid="b-zu.b6"
            >
              <div className="mb-12 max-w-[360px] lg:mb-16" data-oid="1eswer_">
                <Link
                  href="/"
                ...
                <p
                  ...
                  data-oid="howamof"
                >
                  © 2025 Kyron Medical Inc, all rights reserved.
                </p>
                <div
            ...
            <div
              ...
              data-oid="ru_-8-3"
            >
              <div className="mb-12 lg:mb-16" data-oid="in_zvyh">
                <h2
            ...
            <div
              ...
              data-oid="sup6d00"
            >
              <div className="mb-12 lg:mb-16" data-oid="2.i_5oo">
                <h2
                  className="mb-10 text-xl font-bold text-black dark:text-white"
                  data-oid="kt.jve0"
                >
