  ...
  return (
    <>
      <footer
        ...
        data-oid="3z_k1p9"
      >
        <div className="container mx-auto px-4" data-oid="4eay91e">
          <div className="-mx-4 flex flex-wrap" data-oid=".xyz44u">
            <div
              className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12"
              data-oid="17gifod"
            >
              <div className="mb-12 max-w-[360px] lg:mb-16" data-oid="knx0.s3">
                <Link
                  href="/"
            ...
            <div
              ...
              data-oid="8:8y14u"
            >
              <div className="mb-12 lg:mb-16" data-oid="mh6aegl">
                <h2
            ...
            <div
              ...
              data-oid="va28jbg"
            >
              <div className="mb-12 lg:mb-16" data-oid=":3zrz1c">
                <h2
                  className="mb-10 text-xl font-bold text-black dark:text-white"
                  data-oid="a9vartw"
                >
