  ...
  return (
    <>
      <footer
        ...
        data-oid="aa.ou2v"
      >
        <div className="container mx-auto px-4" data-oid="ll6t1nd">
          <div className="-mx-4 flex flex-wrap" data-oid="bghqzvr">
            <div
              className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12"
              data-oid="y29_idv"
            >
              <div className="mb-12 max-w-[360px] lg:mb-16" data-oid="wmpcmy8">
                <Link
                  href="/"
            ...
            <div
              ...
              data-oid="izpxnux"
            >
              <div className="mb-12 lg:mb-16" data-oid="j5d9cti">
                <h2
            ...
            <div
              ...
              data-oid="7n.mmx2"
            >
              <div className="mb-12 lg:mb-16" data-oid="z0mqgnk">
                <h2
                  className="mb-10 text-xl font-bold text-black dark:text-white"
                  data-oid="qggs.dg"
                >
