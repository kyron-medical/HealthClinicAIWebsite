  ...
  return (
    <>
      <section
        ...
        data-oid="izn2.31"
      >
        <div className="container" data-oid="yeszh6i">
          <div className="-mx-4 flex flex-wrap" data-oid="_ex:7c1">
            <div className="w-full px-4" data-oid="skbvrnl">
              <div
        ...
        <div className="absolute left-0 top-0 z-[-1]" data-oid="h7l_87-">
          <svg
            width="1440"
            height="969"
          ...
          >
            ...
            <g mask="url(#mask0_95:1005)" data-oid="kwmzxug">
              <path
                opacity="0.1"
            ...
            <defs data-oid="fup7x0b">
              <linearGradient
                ...
                data-oid="7v6p.4l"
              >
                <stop stopColor="#4A6CF7" data-oid="._b7mb2" />
                <stop
                  offset="1"
                  stopColor="#4A6CF7"
                  stopOpacity="0"
              ...
              <linearGradient
                ...
                data-oid="5ovv24v"
              >
                <stop stopColor="#4A6CF7" data-oid="ecgmwjz" />
                <stop
                  offset="1"
                  stopColor="#4A6CF7"
                  stopOpacity="0"
