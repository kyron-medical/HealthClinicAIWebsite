  ...
  return (
    <>
      <section
        ...
        data-oid="az5td05"
      >
        <div className="container" data-oid="p:1grre">
          <div className="-mx-4 flex flex-wrap" data-oid="m4o6zmv">
            <div className="w-full px-4" data-oid="7975aqp">
              <div
        ...
        <div className="absolute left-0 top-0 z-[-1]" data-oid="nqq575u">
          <svg
            width="1440"
            height="969"
          ...
          >
            ...
            <g mask="url(#mask0_95:1005)" data-oid="2jl5ibb">
              <path
                opacity="0.1"
            ...
            <defs data-oid="vso-6bv">
              <linearGradient
                ...
                data-oid="clf7t16"
              >
                <stop stopColor="#4A6CF7" data-oid="_7-x5y:" />
                <stop
                  offset="1"
                  stopColor="#4A6CF7"
                  stopOpacity="0"
              ...
              <linearGradient
                ...
                data-oid="rn5pqzy"
              >
                <stop stopColor="#4A6CF7" data-oid="w7dvw4p" />
                <stop
                  offset="1"
                  stopColor="#4A6CF7"
                  stopOpacity="0"
