...
export const metadata: Metadata = {
  title: "Sign Up Page | Kyron",
  description: "Sign Up for Kyron",
  // other metadata
};
  ...
  return (
    <>
      <section
        ...
        data-oid="7e:6fzn"
      >
        <div className="container" data-oid="v-6z_.6">
          <div className="-mx-4 flex flex-wrap" data-oid="7q:w_81">
            <div className="w-full px-4" data-oid="k5b9iqg">
              <div
                ...
                <SignUp
                  appearance={{
                    elements: {
                      ...
                      footer:
                        "bg-white dark:bg-dark text-center text-base font-medium text-body-color",
                      formFieldLabel:
        ...
        <div className="absolute left-0 top-0 z-[-1]" data-oid="l.6k:u5">
          <svg
            width="1440"
            height="969"
          ...
          >
            ...
            <g mask="url(#mask0_95:1005)" data-oid="q:3fte9">
              <path
                opacity="0.1"
            ...
            <defs data-oid="x96a8aa">
              <linearGradient
                ...
                data-oid="8v9r4hh"
              >
                <stop stopColor="#4A6CF7" data-oid="9pc:69a" />
                <stop
                  offset="1"
                  stopColor="#4A6CF7"
                  stopOpacity="0"
              ...
              <linearGradient
                ...
                data-oid="7k.5a74"
              >
                <stop stopColor="#4A6CF7" data-oid="bcaz6a8" />
                <stop
                  offset="1"
                  stopColor="#4A6CF7"
                  stopOpacity="0"
