  ...
  return (
    <>
      <section
        ...
        data-oid="qlke.3p"
      >
        <div className="container" data-oid="z92y0d_">
          <div className="-mx-4 flex flex-wrap" data-oid=".1vxoiu">
            <div className="w-full px-4" data-oid="w-k4iy-">
              <div
        ...
        <div className="absolute left-0 top-0 z-[-1]" data-oid=":u9f5o-">
          <svg
            width="1440"
            height="969"
          ...
          >
            ...
            <g mask="url(#mask0_95:1005)" data-oid="jzhwif6">
              <path
                opacity="0.1"
            ...
            <defs data-oid="y_4v7e-">
              <linearGradient
                ...
                data-oid="3gg-yw-"
              >
                <stop stopColor="#4A6CF7" data-oid="yfqywms" />
                <stop
                  offset="1"
                  stopColor="#4A6CF7"
                  stopOpacity="0"
              ...
              <linearGradient
                ...
                data-oid="9txxm7n"
              >
                <stop stopColor="#4A6CF7" data-oid="yeeiwt9" />
                <stop
                  offset="1"
                  stopColor="#4A6CF7"
                  stopOpacity="0"
