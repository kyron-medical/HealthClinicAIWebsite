  ...
  return (
    <>
      <section
        ...
        data-oid="rpubteg"
      >
        <div className="container" data-oid="qio8:7f">
          <div className="-mx-4 flex flex-wrap" data-oid="z_l.gk-">
            <div className="w-full px-4" data-oid="epdgnap">
              <div
        ...
        <div className="absolute left-0 top-0 z-[-1]" data-oid="mtu92mo">
          <svg
            width="1440"
            height="969"
          ...
          >
            ...
            <g mask="url(#mask0_95:1005)" data-oid="kpzejq5">
              <path
                opacity="0.1"
            ...
            <defs data-oid="ex9r2zi">
              <linearGradient
                ...
                data-oid="9pi7prj"
              >
                <stop stopColor="#4A6CF7" data-oid="ao:0mue" />
                <stop
                  offset="1"
                  stopColor="#4A6CF7"
                  stopOpacity="0"
              ...
              <linearGradient
                ...
                data-oid="d0llh-7"
              >
                <stop stopColor="#4A6CF7" data-oid="z4usdqc" />
                <stop
                  offset="1"
                  stopColor="#4A6CF7"
                  stopOpacity="0"
