  ...
  return (
    <>
      <section
        ...
        data-oid="aep:_.s"
      >
        <div className="container" data-oid="ir-1du:">
          <div className="-mx-4 flex flex-wrap" data-oid="02o23vt">
            <div className="w-full px-4" data-oid="l0-rj1m">
              <div
        ...
        <div className="absolute left-0 top-0 z-[-1]" data-oid="bpwoucd">
          <svg
            width="1440"
            height="969"
          ...
          >
            ...
            <g mask="url(#mask0_95:1005)" data-oid="q6y9a_d">
              <path
                opacity="0.1"
            ...
            <defs data-oid="guztaoz">
              <linearGradient
                ...
                data-oid="3ww8gjd"
              >
                <stop stopColor="#4A6CF7" data-oid="i_ok0d5" />
                <stop
                  offset="1"
                  stopColor="#4A6CF7"
                  stopOpacity="0"
              ...
              <linearGradient
                ...
                data-oid="nyg6ar1"
              >
                <stop stopColor="#4A6CF7" data-oid="4.6hm9l" />
                <stop
                  offset="1"
                  stopColor="#4A6CF7"
                  stopOpacity="0"
