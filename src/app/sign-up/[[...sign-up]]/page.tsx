  ...
  return (
    <>
      <section
        ...
        data-oid=".qi88e5"
      >
        <div className="container" data-oid="-uvpwdn">
          <div className="-mx-4 flex flex-wrap" data-oid="2wjtb_6">
            <div className="w-full px-4" data-oid="txacbnn">
              <div
        ...
        <div className="absolute left-0 top-0 z-[-1]" data-oid="h8uuo.3">
          <svg
            width="1440"
            height="969"
          ...
          >
            ...
            <g mask="url(#mask0_95:1005)" data-oid="xd97s8l">
              <path
                opacity="0.1"
            ...
            <defs data-oid="tp_eo9d">
              <linearGradient
                ...
                data-oid="ux871-f"
              >
                <stop stopColor="#4A6CF7" data-oid="b4ygiw7" />
                <stop
                  offset="1"
                  stopColor="#4A6CF7"
                  stopOpacity="0"
              ...
              <linearGradient
                ...
                data-oid="_8xtg9a"
              >
                <stop stopColor="#4A6CF7" data-oid="15:_h3z" />
                <stop
                  offset="1"
                  stopColor="#4A6CF7"
                  stopOpacity="0"
