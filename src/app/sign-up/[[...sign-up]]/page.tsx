  ...
  return (
    <>
      <section
        ...
        data-oid=":jl8.o-"
      >
        <div className="container" data-oid="8j:5j2u">
          <div className="-mx-4 flex flex-wrap" data-oid="bts744c">
            <div className="w-full px-4" data-oid=":3t4g1n">
              <div
        ...
        <div className="absolute left-0 top-0 z-[-1]" data-oid="tkoki:f">
          <svg
            width="1440"
            height="969"
          ...
          >
            ...
            <g mask="url(#mask0_95:1005)" data-oid="7x56:d-">
              <path
                opacity="0.1"
            ...
            <defs data-oid="p9:..lz">
              <linearGradient
                ...
                data-oid="_jusozj"
              >
                <stop stopColor="#4A6CF7" data-oid="3ij2zqq" />
                <stop
                  offset="1"
                  stopColor="#4A6CF7"
                  stopOpacity="0"
              ...
              <linearGradient
                ...
                data-oid="s61b.hi"
              >
                <stop stopColor="#4A6CF7" data-oid="e_bmd.k" />
                <stop
                  offset="1"
                  stopColor="#4A6CF7"
                  stopOpacity="0"
