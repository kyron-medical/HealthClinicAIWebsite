  ...
  return (
    <>
      <section
        ...
        data-oid="k-7jy4a"
      >
        <div className="container" data-oid="t6fsv03">
          <div className="-mx-4 flex flex-wrap" data-oid="t96pp-b">
            <div className="w-full px-4" data-oid="r98huag">
              <div
        ...
        <div className="absolute left-0 top-0 z-[-1]" data-oid="fucg99_">
          <svg
            width="1440"
            height="969"
          ...
          >
            ...
            <g mask="url(#mask0_95:1005)" data-oid="9mx-nng">
              <path
                opacity="0.1"
            ...
            <defs data-oid="u0dkmrq">
              <linearGradient
                ...
                data-oid="3i3qzhi"
              >
                <stop stopColor="#4A6CF7" data-oid="fy7pe4." />
                <stop
                  offset="1"
                  stopColor="#4A6CF7"
                  stopOpacity="0"
              ...
              <linearGradient
                ...
                data-oid="2bp2mot"
              >
                <stop stopColor="#4A6CF7" data-oid="kj4b5xv" />
                <stop
                  offset="1"
                  stopColor="#4A6CF7"
                  stopOpacity="0"
