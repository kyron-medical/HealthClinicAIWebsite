...
const Blog = () => {
  ...
  return (
    <>
      ...
      <section className="pb-[120px] pt-[120px]" data-oid="k_7e-i1">
        <div className="container" data-oid="nke-l4e">
          {/* <div
            ...
            {blogData.map((blog) => (
              ...
              >
                ...
                <div
                  ...
                  data-oid="72cuonf"
                >
                  <TbLogs data-oid="3oz0og2" />
                </div>
                <div className="p-6" data-oid="8m7ym3h">
                  <h3
                  ...
                  {/* Footer */}
                  <div className="mt-4" data-oid="z0857pq">
                    <hr className="mb-4" data-oid="y6mnuie" />
                    <button
                      onClick={() => {
                        setCurrentResource({
                          url: blog.link,
