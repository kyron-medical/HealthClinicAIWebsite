                ...
                >
                  ...
                  >
                    <h3
                      ...
                      data-oid="7nia7ma"
                    >
                      What kind of ROI can I expect from implementing Kyron?
                    </h3>
                    <svg
                      className="h-5 w-5 text-gray-500 dark:text-gray-400"
                      fill="none"
                  ...
                  >
                    <p
                      ...
                      data-oid="3g-n4-."
                    >
                      Healthcare providers implementing Kyron typically see
                      significant return on investment across multiple areas:
                    </p>
                    <div
                      className="mb-4 grid grid-cols-3 gap-4 text-center"
                      data-oid="3-wyk40"
                    >
                      <div
                    ...
                    <p
                      ...
                      data-oid="gh64qar"
                    >
                      These improvements typically translate to an ROI of
                      300-500% within the first year of implementation. The
                      exact return varies based on your practice size,
                      specialty, and current revenue cycle efficiency.
                    </p>
                  </div>
                </div>
              </div>
