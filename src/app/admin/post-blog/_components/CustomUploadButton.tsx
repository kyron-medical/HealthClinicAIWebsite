...
export function CustomUploadButton({
  ...
  const { inputProps } = useUploadThingInputProps("imageUploader", {
    onUploadBegin() {
      toast.loading(
        <div className="flex items-center gap-2" data-oid="hjddnfw">
          <LoadingSpinnerSVG data-oid="wqo1spy" />
          <span className="text-lg" data-oid="-82ix_z">
            Uploading image...
          </span>
        </div>,
        {
  ...
  return (
    <div data-oid="8ukbeut">
      <label
        htmlFor="upload-button"
        className="cursor-pointer"
        data-oid="r4if8gf"
      >
        <AddPostIcon data-oid="hzgtm8u" />
      </label>
      <input
        id="upload-button"
        type="file"
