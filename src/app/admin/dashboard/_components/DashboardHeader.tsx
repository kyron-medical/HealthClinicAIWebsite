  ...
  return (
    ...
    >
      <div data-oid="ringnui">
        ...
        <p className="mt-1 text-gray-600 dark:text-gray-300" data-oid="sbte:ao">
          Here's what's happening with your practice today.
        </p>
      </div>
      <div className="flex items-center gap-3" data-oid="ld14iui">
        <button
          ...
          data-oid="5vklnmq"
        >
          <span className="flex items-center gap-2" data-oid="lurdbzp">
            <svg
        ...
        <button
          ...
          data-oid="tkxj6ni"
        >
          <span className="flex items-center gap-2" data-oid="lc_nwob">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
