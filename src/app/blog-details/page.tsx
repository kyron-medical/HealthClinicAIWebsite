...
const BlogDetailsPage = () => {
  return (
    <>
      <section className="pb-[120px] pt-[150px]" data-oid="jzxcqem">
        <div className="container" data-oid="a8_w4hz">
          <div
            className="-mx-4 flex flex-wrap justify-center"
            data-oid="svx:zr4"
          >
            <div className="w-full px-4 lg:w-8/12" data-oid=":uxl4s_">
              <div data-oid="73k5n6v">
                <h2
                ...
                >
                  ...
                  >
                    <div
                      ...
                      data-oid="jw_k..w"
                    >
                      <div className="mr-4" data-oid="n950tir">
                        <div
                      ...
                      <div className="w-full" data-oid="405d:b:">
                        <span
                          className="mb-1 text-base font-medium text-body-color"
                          data-oid="wr.c60y"
                        >
                          By <span data-oid=":7-c3u0">Musharof Chy</span>
                        </span>
                      </div>
                    </div>
                    <div className="mb-5 flex items-center" data-oid="7q3gp64">
                      <p
                        className="mr-5 flex items-center text-base font-medium text-body-color"
                        data-oid="4btqn1z"
                      >
                        <span className="mr-3" data-oid="2diz-qt">
                          <svg
                            width="15"
                            height="15"
                            viewBox="0 0 15 15"
                      ...
                      <p
                        ...
                        data-oid="wq3k2rv"
                      >
                        <span className="mr-3" data-oid="j-g3d40">
                          <svg
                            width="18"
                            height="13"
                            viewBox="0 0 18 13"
                      ...
                      <p
                        ...
                        data-oid="_3j1w-f"
                      >
                        <span className="mr-3" data-oid="99ko_cb">
                          <svg
                            width="20"
                            height="12"
                            viewBox="0 0 20 12"
                  ...
                  <div className="mb-5" data-oid="_.zufmj">
                    <a
                      href="#0"
                ...
                <div data-oid="kb8g-hg">
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <g mask="url(#mask0_111:596)" data-oid="by3tl_2">
                          <circle
                            opacity="0.8"
                            cx="37.5"
                            cy="37.5"
                        ...
                        <defs data-oid="2huxc0a">
                          ...
                          <radialGradient
                            ...
                            data-oid="26zxw4w"
                          >
                            <stop stopOpacity="0.47" data-oid="79v2_8b" />
                            <stop
                              offset="1"
                              stopOpacity="0"
                              data-oid="dtd.fnc"
                  ...
                  <div
                    ...
                    data-oid="bwr.a2:"
                  >
                    <div className="mb-5" data-oid="ghla1ia">
                      <h4
                      ...
                      <div className="flex items-center" data-oid="kfg1lh9">
                        <TagButton text="Design" data-oid="i9qidz." />
                        <TagButton text="Development" data-oid="e711b17" />
                        <TagButton text="Info" data-oid=".p.hcj-" />
                      </div>
                    </div>
                    <div className="mb-5" data-oid="3rc:i7k">
                      <h5
