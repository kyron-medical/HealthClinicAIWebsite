...
const BlogDetailsPage = () => {
  return (
    <>
      <section className="pb-[120px] pt-[150px]" data-oid="fmf9g0x">
        <div className="container" data-oid="3cz1lqg">
          <div
            className="-mx-4 flex flex-wrap justify-center"
            data-oid="o_:9knb"
          >
            <div className="w-full px-4 lg:w-8/12" data-oid="vcf2x05">
              <div data-oid="bx5z79:">
                <h2
                ...
                >
                  ...
                  >
                    <div
                      ...
                      data-oid="qmizyu6"
                    >
                      <div className="mr-4" data-oid="8co9s0j">
                        <div
                      ...
                      <div className="w-full" data-oid="112xgg5">
                        <span
                          className="mb-1 text-base font-medium text-body-color"
                          data-oid="ec:v2yj"
                        >
                          By <span data-oid="putrtss">Musharof Chy</span>
                        </span>
                      </div>
                    </div>
                    <div className="mb-5 flex items-center" data-oid="3qxx3xs">
                      <p
                        className="mr-5 flex items-center text-base font-medium text-body-color"
                        data-oid="0qyzo-t"
                      >
                        <span className="mr-3" data-oid="fc40cl.">
                          <svg
                            width="15"
                            height="15"
                            viewBox="0 0 15 15"
                      ...
                      <p
                        ...
                        data-oid="ymb9:.9"
                      >
                        <span className="mr-3" data-oid="gtd58l6">
                          <svg
                            width="18"
                            height="13"
                            viewBox="0 0 18 13"
                      ...
                      <p
                        ...
                        data-oid="vo_:b8h"
                      >
                        <span className="mr-3" data-oid="jyy8rad">
                          <svg
                            width="20"
                            height="12"
                            viewBox="0 0 20 12"
                  ...
                  <div className="mb-5" data-oid="04c95d3">
                    <a
                      href="#0"
                ...
                <div data-oid="0l5-0gp">
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <g mask="url(#mask0_111:596)" data-oid="rgb18_d">
                          <circle
                            opacity="0.8"
                            cx="37.5"
                            cy="37.5"
                        ...
                        <defs data-oid="m5.im-f">
                          ...
                          <radialGradient
                            ...
                            data-oid="x5ej-4q"
                          >
                            <stop stopOpacity="0.47" data-oid="6_2nu.p" />
                            <stop
                              offset="1"
                              stopOpacity="0"
                              data-oid="izwkm3c"
                  ...
                  <div
                    ...
                    data-oid="9pdpr2j"
                  >
                    <div className="mb-5" data-oid="nzwlnlz">
                      <h4
                      ...
                      <div className="flex items-center" data-oid="92egj4x">
                        <TagButton text="Design" data-oid="4w_hm-p" />
                        <TagButton text="Development" data-oid="lxz5eec" />
                        <TagButton text="Info" data-oid="20fys3_" />
                      </div>
                    </div>
                    <div className="mb-5" data-oid="m-ic_us">
                      <h5
