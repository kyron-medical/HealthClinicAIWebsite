...
const BlogDetailsPage = () => {
  return (
    <>
      <section className="pb-[120px] pt-[150px]" data-oid="zo1b6an">
        <div className="container" data-oid="82xh4oz">
          <div
            className="-mx-4 flex flex-wrap justify-center"
            data-oid="z171c2i"
          >
            <div className="w-full px-4 lg:w-8/12" data-oid="m2n-hgv">
              <div data-oid="prv6:dc">
                <h2
                ...
                >
                  ...
                  >
                    <div
                      ...
                      data-oid="soz9:w_"
                    >
                      <div className="mr-4" data-oid="w9trc6b">
                        <div
                      ...
                      <div className="w-full" data-oid="xep6lu4">
                        <span
                          className="mb-1 text-base font-medium text-body-color"
                          data-oid="x5atc_5"
                        >
                          By <span data-oid="j-c8_oc">Musharof Chy</span>
                        </span>
                      </div>
                    </div>
                    <div className="mb-5 flex items-center" data-oid="i5pm6ho">
                      <p
                        className="mr-5 flex items-center text-base font-medium text-body-color"
                        data-oid="mcs9c5n"
                      >
                        <span className="mr-3" data-oid="iev.gp2">
                          <svg
                            width="15"
                            height="15"
                            viewBox="0 0 15 15"
                      ...
                      <p
                        ...
                        data-oid="ehfp_zn"
                      >
                        <span className="mr-3" data-oid="duq3gt-">
                          <svg
                            width="18"
                            height="13"
                            viewBox="0 0 18 13"
                      ...
                      <p
                        ...
                        data-oid="3js07xu"
                      >
                        <span className="mr-3" data-oid="erfaiky">
                          <svg
                            width="20"
                            height="12"
                            viewBox="0 0 20 12"
                  ...
                  <div className="mb-5" data-oid="__eft.x">
                    <a
                      href="#0"
                ...
                <div data-oid="gm2tpdr">
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <g mask="url(#mask0_111:596)" data-oid="7nk-m5n">
                          <circle
                            opacity="0.8"
                            cx="37.5"
                            cy="37.5"
                        ...
                        <defs data-oid="pd.ipw2">
                          ...
                          <radialGradient
                            ...
                            data-oid="9vk4x0w"
                          >
                            <stop stopOpacity="0.47" data-oid="bljnktd" />
                            <stop
                              offset="1"
                              stopOpacity="0"
                              data-oid="g7f4vu7"
                  ...
                  <div
                    ...
                    data-oid="ml1jg0s"
                  >
                    <div className="mb-5" data-oid="qjv:3r7">
                      <h4
                      ...
                      <div className="flex items-center" data-oid=".0:s61s">
                        <TagButton text="Design" data-oid="nvj-k4m" />
                        <TagButton text="Development" data-oid="ls.a4g1" />
                        <TagButton text="Info" data-oid="u830v-s" />
                      </div>
                    </div>
                    <div className="mb-5" data-oid="zx8vtr3">
                      <h5
