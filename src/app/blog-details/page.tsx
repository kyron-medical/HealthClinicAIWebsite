...
const BlogDetailsPage = () => {
  return (
    <>
      <section className="pb-[120px] pt-[150px]" data-oid="k1-_ipc">
        <div className="container" data-oid="nrox-lh">
          <div
            className="-mx-4 flex flex-wrap justify-center"
            data-oid="qxuelx3"
          >
            <div className="w-full px-4 lg:w-8/12" data-oid="4vulnw9">
              <div data-oid="yd9r86j">
                <h2
                ...
                >
                  ...
                  >
                    <div
                      ...
                      data-oid="amczywq"
                    >
                      <div className="mr-4" data-oid="agb9d:9">
                        <div
                      ...
                      <div className="w-full" data-oid="fi3cwia">
                        <span
                          className="mb-1 text-base font-medium text-body-color"
                          data-oid="t8fwa48"
                        >
                          By <span data-oid="fpsp8jf">Musharof Chy</span>
                        </span>
                      </div>
                    </div>
                    <div className="mb-5 flex items-center" data-oid="qx_uz7s">
                      <p
                        className="mr-5 flex items-center text-base font-medium text-body-color"
                        data-oid="tc6n2j."
                      >
                        <span className="mr-3" data-oid="b_qxg1i">
                          <svg
                            width="15"
                            height="15"
                            viewBox="0 0 15 15"
                      ...
                      <p
                        ...
                        data-oid="uk1:1bp"
                      >
                        <span className="mr-3" data-oid="r.w:.ty">
                          <svg
                            width="18"
                            height="13"
                            viewBox="0 0 18 13"
                      ...
                      <p
                        ...
                        data-oid="gkrza99"
                      >
                        <span className="mr-3" data-oid="59n-ae.">
                          <svg
                            width="20"
                            height="12"
                            viewBox="0 0 20 12"
                  ...
                  <div className="mb-5" data-oid="4.n6qe3">
                    <a
                      href="#0"
                ...
                <div data-oid="llt8n0o">
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <g mask="url(#mask0_111:596)" data-oid="v31-otw">
                          <circle
                            opacity="0.8"
                            cx="37.5"
                            cy="37.5"
                        ...
                        <defs data-oid="ufccw1k">
                          ...
                          <radialGradient
                            ...
                            data-oid="omi9uvy"
                          >
                            <stop stopOpacity="0.47" data-oid="wwnfo7a" />
                            <stop
                              offset="1"
                              stopOpacity="0"
                              data-oid="n6nemq6"
                  ...
                  <div
                    ...
                    data-oid="d4b6krh"
                  >
                    <div className="mb-5" data-oid="gcna1tc">
                      <h4
                      ...
                      <div className="flex items-center" data-oid="037f4y6">
                        <TagButton text="Design" data-oid="u9ahgd3" />
                        <TagButton text="Development" data-oid="hk1xato" />
                        <TagButton text="Info" data-oid="s2m_h0m" />
                      </div>
                    </div>
                    <div className="mb-5" data-oid="ipl8:17">
                      <h5
