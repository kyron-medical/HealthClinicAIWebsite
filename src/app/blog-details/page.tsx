...
const BlogDetailsPage = () => {
  return (
    <>
      <section className="pb-[120px] pt-[150px]" data-oid=":i6-aqq">
        <div className="container" data-oid="lkcycdv">
          <div
            className="-mx-4 flex flex-wrap justify-center"
            data-oid="hpyn_gn"
          >
            <div className="w-full px-4 lg:w-8/12" data-oid="utvm:sv">
              <div data-oid="3hbqnqd">
                <h2
                ...
                >
                  ...
                  >
                    <div
                      ...
                      data-oid="1:kjehk"
                    >
                      <div className="mr-4" data-oid="zh5y11z">
                        <div
                      ...
                      <div className="w-full" data-oid="213apq5">
                        <span
                          className="mb-1 text-base font-medium text-body-color"
                          data-oid="p:3hd7y"
                        >
                          By <span data-oid="t7:_haq">Musharof Chy</span>
                        </span>
                      </div>
                    </div>
                    <div className="mb-5 flex items-center" data-oid="nsromvh">
                      <p
                        className="mr-5 flex items-center text-base font-medium text-body-color"
                        data-oid="mi5ghh9"
                      >
                        <span className="mr-3" data-oid="vtf747v">
                          <svg
                            width="15"
                            height="15"
                            viewBox="0 0 15 15"
                      ...
                      <p
                        ...
                        data-oid="gig-q8s"
                      >
                        <span className="mr-3" data-oid="29db4bz">
                          <svg
                            width="18"
                            height="13"
                            viewBox="0 0 18 13"
                      ...
                      <p
                        ...
                        data-oid="ukj:f5-"
                      >
                        <span className="mr-3" data-oid="ejoliaz">
                          <svg
                            width="20"
                            height="12"
                            viewBox="0 0 20 12"
                  ...
                  <div className="mb-5" data-oid="v8va8hd">
                    <a
                      href="#0"
                ...
                <div data-oid="iz8pv6o">
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <g mask="url(#mask0_111:596)" data-oid="tjctl1r">
                          <circle
                            opacity="0.8"
                            cx="37.5"
                            cy="37.5"
                        ...
                        <defs data-oid="btkrtt8">
                          ...
                          <radialGradient
                            ...
                            data-oid="5pno1hq"
                          >
                            <stop stopOpacity="0.47" data-oid="ij-tybd" />
                            <stop
                              offset="1"
                              stopOpacity="0"
                              data-oid="-t-qik5"
                  ...
                  <div
                    ...
                    data-oid="r2ay8l2"
                  >
                    <div className="mb-5" data-oid="n6ymwe:">
                      <h4
                      ...
                      <div className="flex items-center" data-oid="vdw2mi:">
                        <TagButton text="Design" data-oid="d1:1g7d" />
                        <TagButton text="Development" data-oid="4rarzom" />
                        <TagButton text="Info" data-oid="1zwmv6-" />
                      </div>
                    </div>
                    <div className="mb-5" data-oid="pe7ux5b">
                      <h5
