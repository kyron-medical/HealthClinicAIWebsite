...
const BlogDetailsPage = () => {
  return (
    <>
      <section className="pb-[120px] pt-[150px]" data-oid="6jlv4c6">
        <div className="container" data-oid="q6c.ut2">
          <div
            className="-mx-4 flex flex-wrap justify-center"
            data-oid="3xx-8y2"
          >
            <div className="w-full px-4 lg:w-8/12" data-oid="0g:rmec">
              <div data-oid="aj2bpbv">
                <h2
                ...
                >
                  ...
                  >
                    <div
                      ...
                      data-oid="ouncz9k"
                    >
                      <div className="mr-4" data-oid="_bfpa:m">
                        <div
                      ...
                      <div className="w-full" data-oid="0pn94ox">
                        <span
                          className="mb-1 text-base font-medium text-body-color"
                          data-oid="o:u37xb"
                        >
                          By <span data-oid="kj232sb">Musharof Chy</span>
                        </span>
                      </div>
                    </div>
                    <div className="mb-5 flex items-center" data-oid="mw8znjc">
                      <p
                        className="mr-5 flex items-center text-base font-medium text-body-color"
                        data-oid="wmmog.n"
                      >
                        <span className="mr-3" data-oid="2h_108:">
                          <svg
                            width="15"
                            height="15"
                            viewBox="0 0 15 15"
                      ...
                      <p
                        ...
                        data-oid="5vvftnp"
                      >
                        <span className="mr-3" data-oid="1k480s1">
                          <svg
                            width="18"
                            height="13"
                            viewBox="0 0 18 13"
                      ...
                      <p
                        ...
                        data-oid="547.xdn"
                      >
                        <span className="mr-3" data-oid="oy-.d6b">
                          <svg
                            width="20"
                            height="12"
                            viewBox="0 0 20 12"
                  ...
                  <div className="mb-5" data-oid="69bzd3s">
                    <a
                      href="#0"
                ...
                <div data-oid="pm_igp6">
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <g mask="url(#mask0_111:596)" data-oid="vm4t:9f">
                          <circle
                            opacity="0.8"
                            cx="37.5"
                            cy="37.5"
                        ...
                        <defs data-oid="e06cy2j">
                          ...
                          <radialGradient
                            ...
                            data-oid="aaub_bt"
                          >
                            <stop stopOpacity="0.47" data-oid="texmc.p" />
                            <stop
                              offset="1"
                              stopOpacity="0"
                              data-oid="n74zzvg"
                  ...
                  <div
                    ...
                    data-oid="cs1d__w"
                  >
                    <div className="mb-5" data-oid="s_4oowj">
                      <h4
                      ...
                      <div className="flex items-center" data-oid="ujhse_0">
                        <TagButton text="Design" data-oid="j88d.yh" />
                        <TagButton text="Development" data-oid="cp.j3h3" />
                        <TagButton text="Info" data-oid="t5r49rt" />
                      </div>
                    </div>
                    <div className="mb-5" data-oid="zwoq20s">
                      <h5
