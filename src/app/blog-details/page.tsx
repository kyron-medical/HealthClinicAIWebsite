...
const BlogDetailsPage = () => {
  return (
    <>
      <section className="pb-[120px] pt-[150px]" data-oid="y7prp9x">
        <div className="container" data-oid="9flc8jm">
          <div
            className="-mx-4 flex flex-wrap justify-center"
            data-oid="5fgcoz8"
          >
            <div className="w-full px-4 lg:w-8/12" data-oid="-ug1ril">
              <div data-oid="et:ljw6">
                <h2
                ...
                >
                  ...
                  >
                    <div
                      ...
                      data-oid=".agzq9u"
                    >
                      <div className="mr-4" data-oid="_m9v:0t">
                        <div
                      ...
                      <div className="w-full" data-oid="6lu6b.g">
                        <span
                          className="mb-1 text-base font-medium text-body-color"
                          data-oid="hibb4xi"
                        >
                          By <span data-oid="5_34xf4">Musharof Chy</span>
                        </span>
                      </div>
                    </div>
                    <div className="mb-5 flex items-center" data-oid="6zxtjaz">
                      <p
                        className="mr-5 flex items-center text-base font-medium text-body-color"
                        data-oid="savmqdy"
                      >
                        <span className="mr-3" data-oid="4xaf.3k">
                          <svg
                            width="15"
                            height="15"
                            viewBox="0 0 15 15"
                      ...
                      <p
                        ...
                        data-oid="bdjw6zj"
                      >
                        <span className="mr-3" data-oid="c74x6pe">
                          <svg
                            width="18"
                            height="13"
                            viewBox="0 0 18 13"
                      ...
                      <p
                        ...
                        data-oid="y.r8ao0"
                      >
                        <span className="mr-3" data-oid="qstk21s">
                          <svg
                            width="20"
                            height="12"
                            viewBox="0 0 20 12"
                  ...
                  <div className="mb-5" data-oid="sqxnedy">
                    <a
                      href="#0"
                ...
                <div data-oid="88phtqm">
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <g mask="url(#mask0_111:596)" data-oid="wjyh3tp">
                          <circle
                            opacity="0.8"
                            cx="37.5"
                            cy="37.5"
                        ...
                        <defs data-oid="c90xka:">
                          ...
                          <radialGradient
                            ...
                            data-oid="mvzl727"
                          >
                            <stop stopOpacity="0.47" data-oid="2rvc_th" />
                            <stop
                              offset="1"
                              stopOpacity="0"
                              data-oid="4vv4f7h"
                  ...
                  <div
                    ...
                    data-oid="qg2jlfd"
                  >
                    <div className="mb-5" data-oid="9au9w9_">
                      <h4
                      ...
                      <div className="flex items-center" data-oid="8v3x181">
                        <TagButton text="Design" data-oid="cwfn24-" />
                        <TagButton text="Development" data-oid="ldmlk-g" />
                        <TagButton text="Info" data-oid="xsrb7t2" />
                      </div>
                    </div>
                    <div className="mb-5" data-oid="ipphnfr">
                      <h5
