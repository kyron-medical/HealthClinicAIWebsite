...
const BlogDetailsPage = () => {
  return (
    <>
      <section className="pb-[120px] pt-[150px]" data-oid=":_w73qv">
        <div className="container" data-oid="x4lz2ul">
          <div
            className="-mx-4 flex flex-wrap justify-center"
            data-oid="3hg5z7n"
          >
            <div className="w-full px-4 lg:w-8/12" data-oid="bpt9iy2">
              <div data-oid="hxj_id:">
                <h2
                ...
                >
                  ...
                  >
                    <div
                      ...
                      data-oid="0oo_afh"
                    >
                      <div className="mr-4" data-oid="8w.u9ye">
                        <div
                      ...
                      <div className="w-full" data-oid="4.tsu3p">
                        <span
                          className="mb-1 text-base font-medium text-body-color"
                          data-oid="ra:ni3t"
                        >
                          By <span data-oid="gvnpef7">Musharof Chy</span>
                        </span>
                      </div>
                    </div>
                    <div className="mb-5 flex items-center" data-oid="bqouzpo">
                      <p
                        className="mr-5 flex items-center text-base font-medium text-body-color"
                        data-oid="zmmyg.d"
                      >
                        <span className="mr-3" data-oid="gij4eio">
                          <svg
                            width="15"
                            height="15"
                            viewBox="0 0 15 15"
                      ...
                      <p
                        ...
                        data-oid="y-.3wvl"
                      >
                        <span className="mr-3" data-oid="t6d69dz">
                          <svg
                            width="18"
                            height="13"
                            viewBox="0 0 18 13"
                      ...
                      <p
                        ...
                        data-oid="0b3gisx"
                      >
                        <span className="mr-3" data-oid="6pzduiy">
                          <svg
                            width="20"
                            height="12"
                            viewBox="0 0 20 12"
                  ...
                  <div className="mb-5" data-oid="lfgyu62">
                    <a
                      href="#0"
                ...
                <div data-oid="mk4504q">
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <g mask="url(#mask0_111:596)" data-oid="psvplyc">
                          <circle
                            opacity="0.8"
                            cx="37.5"
                            cy="37.5"
                        ...
                        <defs data-oid="g89kgn1">
                          ...
                          <radialGradient
                            ...
                            data-oid="pvz6tz3"
                          >
                            <stop stopOpacity="0.47" data-oid=":2kgz76" />
                            <stop
                              offset="1"
                              stopOpacity="0"
                              data-oid="6npf4ik"
                  ...
                  <div
                    ...
                    data-oid="o2v15._"
                  >
                    <div className="mb-5" data-oid="wcnftl5">
                      <h4
                      ...
                      <div className="flex items-center" data-oid="d_xkn6d">
                        <TagButton text="Design" data-oid="6amgp13" />
                        <TagButton text="Development" data-oid="cx65_3t" />
                        <TagButton text="Info" data-oid="7whl1qp" />
                      </div>
                    </div>
                    <div className="mb-5" data-oid="zas7gc-">
                      <h5
