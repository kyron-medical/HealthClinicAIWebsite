...
const BlogDetailsPage = () => {
  return (
    <>
      <section className="pb-[120px] pt-[150px]" data-oid="j93s_t:">
        <div className="container" data-oid="yiya7jd">
          <div
            className="-mx-4 flex flex-wrap justify-center"
            data-oid="glf10qf"
          >
            <div className="w-full px-4 lg:w-8/12" data-oid="v65ow:4">
              <div data-oid=".6d57s8">
                <h2
                ...
                >
                  ...
                  >
                    <div
                      ...
                      data-oid="hikbph-"
                    >
                      <div className="mr-4" data-oid="b2cyzby">
                        <div
                      ...
                      <div className="w-full" data-oid="b:54zju">
                        <span
                          className="mb-1 text-base font-medium text-body-color"
                          data-oid="2eiipfq"
                        >
                          By <span data-oid="_zzoody">Musharof Chy</span>
                        </span>
                      </div>
                    </div>
                    <div className="mb-5 flex items-center" data-oid="bym0nqx">
                      <p
                        className="mr-5 flex items-center text-base font-medium text-body-color"
                        data-oid="6hypfvs"
                      >
                        <span className="mr-3" data-oid="am17ms4">
                          <svg
                            width="15"
                            height="15"
                            viewBox="0 0 15 15"
                      ...
                      <p
                        ...
                        data-oid="kqx5xar"
                      >
                        <span className="mr-3" data-oid="5cepjv-">
                          <svg
                            width="18"
                            height="13"
                            viewBox="0 0 18 13"
                      ...
                      <p
                        ...
                        data-oid="m-cyrg8"
                      >
                        <span className="mr-3" data-oid="t-7.x-0">
                          <svg
                            width="20"
                            height="12"
                            viewBox="0 0 20 12"
                  ...
                  <div className="mb-5" data-oid="ipkunn7">
                    <a
                      href="#0"
                ...
                <div data-oid="nclkz-p">
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <g mask="url(#mask0_111:596)" data-oid="k1qxe7k">
                          <circle
                            opacity="0.8"
                            cx="37.5"
                            cy="37.5"
                        ...
                        <defs data-oid="atozwxd">
                          ...
                          <radialGradient
                            ...
                            data-oid="hkl6p1u"
                          >
                            <stop stopOpacity="0.47" data-oid="nbr0tgj" />
                            <stop
                              offset="1"
                              stopOpacity="0"
                              data-oid="7gwo99-"
                  ...
                  <div
                    ...
                    data-oid="yf25e2v"
                  >
                    <div className="mb-5" data-oid="dpr_5-5">
                      <h4
                      ...
                      <div className="flex items-center" data-oid="_x_olu2">
                        <TagButton text="Design" data-oid="kdv5_ds" />
                        <TagButton text="Development" data-oid="pr0sy2e" />
                        <TagButton text="Info" data-oid="z3qoqu7" />
                      </div>
                    </div>
                    <div className="mb-5" data-oid="v_gu42-">
                      <h5
