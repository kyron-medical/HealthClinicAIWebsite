  ...
  return (
    <>
      <section
        ...
        data-oid="8tj5-6i"
      >
        <div className="container mx-auto max-w-3xl" data-oid="_vy66hs">
          <h2 className="text-3xl font-bold mb-6" data-oid="8y-3cy7">
            About Kyron Medical
          </h2>
          <p className="text-lg text-body-color" data-oid="j4vqvw-">
        ...
        <div className="container pt-16" data-oid="sy:rujt">
          <GetStarted data-oid="pdb2nm." />
        </div>
      </section>
    </>
  );
