  ...
  return (
    <>
      <section
        ...
        data-oid="bovf19d"
      >
        <div className="container mx-auto max-w-3xl" data-oid=".:hb7t:">
          <h2 className="text-3xl font-bold mb-6" data-oid="hsvu31l">
            About Kyron Medical
          </h2>
          <p className="text-lg text-body-color" data-oid="5t_kcj8">
        ...
        <div className="container pt-16" data-oid="vyw36d1">
          <GetStarted data-oid="kiwho28" />
        </div>
      </section>
    </>
  );
