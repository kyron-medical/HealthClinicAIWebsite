  ...
  return (
    <>
      <section
        ...
        data-oid="pkl5qf0"
      >
        <div className="container mx-auto max-w-3xl" data-oid="_xyy8fv">
          <h2 className="text-3xl font-bold mb-6" data-oid="ufaq5to">
            About Kyron Medical
          </h2>
          <p className="text-lg text-body-color" data-oid="wd82i6f">
        ...
        <div className="container pt-16" data-oid="luojj36">
          <GetStarted data-oid="1v5dqo_" />
        </div>
      </section>
    </>
  );
