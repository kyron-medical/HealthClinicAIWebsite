  ...
  return (
    <>
      <section
        ...
        data-oid="mpfmg7:"
      >
        <div className="container mx-auto max-w-3xl" data-oid="f2w0qdn">
          <h2 className="text-3xl font-bold mb-6" data-oid="0ry3eq7">
            About Kyron Medical
          </h2>
          <p className="text-lg text-body-color" data-oid="i8mv7sw">
        ...
        <div className="container pt-16" data-oid="zidqs_v">
          <GetStarted data-oid="dzf.6qy" />
        </div>
      </section>
    </>
  );
