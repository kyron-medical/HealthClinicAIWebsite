  ...
  return (
    <>
      <section
        ...
        data-oid="o:9hbgi"
      >
        <div className="container mx-auto max-w-3xl" data-oid="56fw0lp">
          <h2 className="text-3xl font-bold mb-6" data-oid="4kta_wo">
            About Kyron Medical
          </h2>
          <p className="text-lg text-body-color" data-oid="0z99.28">
        ...
        <div className="container pt-16" data-oid="zshi-nc">
          <GetStarted data-oid=".v97zm4" />
        </div>
      </section>
    </>
  );
