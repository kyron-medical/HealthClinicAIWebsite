  ...
  return (
    <>
      <section
        ...
        data-oid="lblbr1o"
      >
        <div className="container" data-oid="4r9x3qm">
          <div className="-mx-4 flex flex-wrap" data-oid="j-j3d9w">
            <div className="w-full px-4" data-oid=":pe-.gs">
              <div
        ...
        <div className="absolute left-0 top-0 z-[-1]" data-oid="3.vpafr">
          <svg
            width="1440"
            height="969"
          ...
          >
            ...
            <g mask="url(#mask0_95:1005)" data-oid="7_dgc2y">
              <path
                opacity="0.1"
            ...
            <defs data-oid="yb8utrx">
              <linearGradient
                ...
                data-oid="3ab3y6p"
              >
                <stop stopColor="#4A6CF7" data-oid="39ak1h:" />
                <stop
                  offset="1"
                  stopColor="#4A6CF7"
                  stopOpacity="0"
              ...
              <linearGradient
                ...
                data-oid="9thzx-u"
              >
                <stop stopColor="#4A6CF7" data-oid="o5l:ys5" />
                <stop
                  offset="1"
                  stopColor="#4A6CF7"
                  stopOpacity="0"
