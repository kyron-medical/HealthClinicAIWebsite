  ...
  return (
    <>
      <section
        ...
        data-oid="4j2uqnn"
      >
        <div className="container" data-oid=".ifg.b0">
          <div className="-mx-4 flex flex-wrap" data-oid="p1fzf:1">
            <div className="w-full px-4" data-oid="p8p54sp">
              <div
        ...
        <div className="absolute left-0 top-0 z-[-1]" data-oid="pwht8m9">
          <svg
            width="1440"
            height="969"
          ...
          >
            ...
            <g mask="url(#mask0_95:1005)" data-oid="j56qfl6">
              <path
                opacity="0.1"
            ...
            <defs data-oid="y76-vut">
              <linearGradient
                ...
                data-oid="cv3y1e7"
              >
                <stop stopColor="#4A6CF7" data-oid="yj5qysy" />
                <stop
                  offset="1"
                  stopColor="#4A6CF7"
                  stopOpacity="0"
              ...
              <linearGradient
                ...
                data-oid="p.g9-qz"
              >
                <stop stopColor="#4A6CF7" data-oid="n:eei:k" />
                <stop
                  offset="1"
                  stopColor="#4A6CF7"
                  stopOpacity="0"
