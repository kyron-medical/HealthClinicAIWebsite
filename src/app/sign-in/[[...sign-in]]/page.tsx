  ...
  return (
    <>
      <section
        ...
        data-oid=":iio_2a"
      >
        <div className="container" data-oid="91f77zf">
          <div className="-mx-4 flex flex-wrap" data-oid="ehu_mj5">
            <div className="w-full px-4" data-oid="mnt5lad">
              <div
        ...
        <div className="absolute left-0 top-0 z-[-1]" data-oid="6:0_mga">
          <svg
            width="1440"
            height="969"
          ...
          >
            ...
            <g mask="url(#mask0_95:1005)" data-oid="g_7-4-0">
              <path
                opacity="0.1"
            ...
            <defs data-oid="xet0ej9">
              <linearGradient
                ...
                data-oid="leogrco"
              >
                <stop stopColor="#4A6CF7" data-oid="ga-s4vg" />
                <stop
                  offset="1"
                  stopColor="#4A6CF7"
                  stopOpacity="0"
              ...
              <linearGradient
                ...
                data-oid="hxa:04m"
              >
                <stop stopColor="#4A6CF7" data-oid="sdq0_4:" />
                <stop
                  offset="1"
                  stopColor="#4A6CF7"
                  stopOpacity="0"
