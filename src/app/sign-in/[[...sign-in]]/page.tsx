  ...
  return (
    <>
      <section
        ...
        data-oid=".a-hk-3"
      >
        <div className="container" data-oid="7.yd5kd">
          <div className="-mx-4 flex flex-wrap" data-oid="o6efvms">
            <div className="w-full px-4" data-oid="abei9z6">
              <div
        ...
        <div className="absolute left-0 top-0 z-[-1]" data-oid="2038f94">
          <svg
            width="1440"
            height="969"
          ...
          >
            ...
            <g mask="url(#mask0_95:1005)" data-oid="4pvt-ej">
              <path
                opacity="0.1"
            ...
            <defs data-oid="4j7gyzn">
              <linearGradient
                ...
                data-oid="993:mao"
              >
                <stop stopColor="#4A6CF7" data-oid="8-7db81" />
                <stop
                  offset="1"
                  stopColor="#4A6CF7"
                  stopOpacity="0"
              ...
              <linearGradient
                ...
                data-oid="vzrspz1"
              >
                <stop stopColor="#4A6CF7" data-oid="799vx6:" />
                <stop
                  offset="1"
                  stopColor="#4A6CF7"
                  stopOpacity="0"
