  ...
  return (
    <>
      <section
        ...
        data-oid="yb:lb-z"
      >
        <div className="container" data-oid="rse0b1f">
          <div className="-mx-4 flex flex-wrap" data-oid="ayz8p0j">
            <div className="w-full px-4" data-oid="_y7.qza">
              <div
        ...
        <div className="absolute left-0 top-0 z-[-1]" data-oid="2acgtvt">
          <svg
            width="1440"
            height="969"
          ...
          >
            ...
            <g mask="url(#mask0_95:1005)" data-oid=":ezcgq.">
              <path
                opacity="0.1"
            ...
            <defs data-oid="uhyukg6">
              <linearGradient
                ...
                data-oid="ry:-0dn"
              >
                <stop stopColor="#4A6CF7" data-oid="191-fkj" />
                <stop
                  offset="1"
                  stopColor="#4A6CF7"
                  stopOpacity="0"
              ...
              <linearGradient
                ...
                data-oid="cnrtinb"
              >
                <stop stopColor="#4A6CF7" data-oid="hg20_8z" />
                <stop
                  offset="1"
                  stopColor="#4A6CF7"
                  stopOpacity="0"
