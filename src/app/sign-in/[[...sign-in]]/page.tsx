  ...
  return (
    <>
      <section
        ...
        data-oid="h7cedq-"
      >
        <div className="container" data-oid="_e.0mr-">
          <div className="-mx-4 flex flex-wrap" data-oid="20ohj51">
            <div className="w-full px-4" data-oid="w9va6p8">
              <div
        ...
        <div className="absolute left-0 top-0 z-[-1]" data-oid=".zm9ork">
          <svg
            width="1440"
            height="969"
          ...
          >
            ...
            <g mask="url(#mask0_95:1005)" data-oid="l2k2qpq">
              <path
                opacity="0.1"
            ...
            <defs data-oid="0f37hrk">
              <linearGradient
                ...
                data-oid="ae0k93j"
              >
                <stop stopColor="#4A6CF7" data-oid="hw3noii" />
                <stop
                  offset="1"
                  stopColor="#4A6CF7"
                  stopOpacity="0"
              ...
              <linearGradient
                ...
                data-oid="tddkmu1"
              >
                <stop stopColor="#4A6CF7" data-oid="f0pd.-z" />
                <stop
                  offset="1"
                  stopColor="#4A6CF7"
                  stopOpacity="0"
