  ...
  return (
    <>
      <section
        ...
        data-oid="vuo4-3t"
      >
        <div className="container" data-oid="eso22w4">
          <div className="-mx-4 flex flex-wrap" data-oid="81jyrow">
            <div className="w-full px-4" data-oid="vx7fy2-">
              <div
        ...
        <div className="absolute left-0 top-0 z-[-1]" data-oid="-1.xgim">
          <svg
            width="1440"
            height="969"
          ...
          >
            ...
            <g mask="url(#mask0_95:1005)" data-oid="mwhuv18">
              <path
                opacity="0.1"
            ...
            <defs data-oid="zz6ckqk">
              <linearGradient
                ...
                data-oid="1y_8hee"
              >
                <stop stopColor="#4A6CF7" data-oid="d4d67sn" />
                <stop
                  offset="1"
                  stopColor="#4A6CF7"
                  stopOpacity="0"
              ...
              <linearGradient
                ...
                data-oid="lab_k0k"
              >
                <stop stopColor="#4A6CF7" data-oid="r0b.g2i" />
                <stop
                  offset="1"
                  stopColor="#4A6CF7"
                  stopOpacity="0"
