...
export const metadata: Metadata = {
  title: "Sign In Page | Kyron",
  description: "Sign In to Kyron",
  // other metadata
};
  ...
  return (
    <>
      <section
        ...
        data-oid="hohz1nl"
      >
        <div className="container" data-oid="ml-hose">
          <div className="-mx-4 flex flex-wrap" data-oid="bmgq6zo">
            <div className="w-full px-4" data-oid="kd0a0xj">
              <div
              ...
              >
                <SignIn
                  appearance={{
                    elements: {
                      card: "bg-white dark:bg-dark sm:p-[60px]",
                      headerTitle:
                        "mb-3 text-center text-2xl font-bold text-black dark:text-white sm:text-3xl",
                      headerSubtitle:
                        "mb-11 text-center text-base font-medium text-body-color",
                      dividerRow: "mb-8 flex items-center justify-center",
                      dividerLine:
                        "hidden h-[1px] w-full max-w-[60px] bg-body-color/50 sm:block",
                      dividerText:
                        "w-full px-5 text-center text-base font-medium text-body-color",
                      footer:
                        "text-center text-base font-medium text-body-color",
                      formFieldLabel:
                        "mb-3 block text-sm text-dark dark:text-white",
                      formFieldInput:
                ...
                {/* <h3 className="mb-3 text-center text-2xl font-bold text-black dark:text-white sm:text-3xl">
                                                 ...
                                                 <p className="mb-11 text-center text-base font-medium text-body-color">
                                                  Login to access your master dashboard
                                                 </p>
        ...
        <div className="absolute left-0 top-0 z-[-1]" data-oid="hczlj1u">
          <svg
            width="1440"
            height="969"
          ...
          >
            ...
            <g mask="url(#mask0_95:1005)" data-oid="i6h5yhy">
              <path
                opacity="0.1"
            ...
            <defs data-oid="8z9zx6a">
              <linearGradient
                ...
                data-oid=".nwjkum"
              >
                <stop stopColor="#4A6CF7" data-oid="pkqw17y" />
                <stop
                  offset="1"
                  stopColor="#4A6CF7"
                  stopOpacity="0"
              ...
              <linearGradient
                ...
                data-oid="qgk8yhx"
              >
                <stop stopColor="#4A6CF7" data-oid="61o9c9l" />
                <stop
                  offset="1"
                  stopColor="#4A6CF7"
                  stopOpacity="0"
