  ...
  return (
    <>
      <section
        ...
        data-oid=":94zwi4"
      >
        <div className="container" data-oid="sq_izo_">
          <div className="-mx-4 flex flex-wrap" data-oid="l9dbowe">
            <div className="w-full px-4" data-oid="ny0429p">
              <div
        ...
        <div className="absolute left-0 top-0 z-[-1]" data-oid="k0xynf0">
          <svg
            width="1440"
            height="969"
          ...
          >
            ...
            <g mask="url(#mask0_95:1005)" data-oid="lseia1.">
              <path
                opacity="0.1"
            ...
            <defs data-oid="gqq_8h_">
              <linearGradient
                ...
                data-oid="p1fqj_1"
              >
                <stop stopColor="#4A6CF7" data-oid="frt1ac-" />
                <stop
                  offset="1"
                  stopColor="#4A6CF7"
                  stopOpacity="0"
              ...
              <linearGradient
                ...
                data-oid=".6qhng-"
              >
                <stop stopColor="#4A6CF7" data-oid="4rn5gew" />
                <stop
                  offset="1"
                  stopColor="#4A6CF7"
                  stopOpacity="0"
