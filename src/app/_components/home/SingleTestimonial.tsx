...
const SingleTestimonial = ({ testimonial }: { testimonial: Testimonial }) => {
  ...
  for (let index = 0; index < star; index++) {
    ratingIcons.push(
      <span key={index} className="text-yellow" data-oid="_kpqp9s">
        {starIcon}
      </span>,
    );
  }
  ...
  return (
    <div className="w-full" data-oid="x9hqg23">
      <div
        ...
        data-oid="3hctk.v"
      >
        <div className="mb-5 flex items-center space-x-1" data-oid="96n2skc">
          {ratingIcons}
        </div>
        <p
        ...
        <div className="flex items-center" data-oid="b3diamx">
          <div
            className="relative mr-4 h-[50px] w-full max-w-[50px] overflow-hidden rounded-full"
            data-oid=":s_rccq"
          >
            <Image src={image} alt={name} fill data-oid="khxhfjs" />
          </div>
          <div className="w-full" data-oid="cphofdk">
            <h3
            ...
            <p className="text-sm text-body-color" data-oid="u:xxx0e">
              {designation}
            </p>
          </div>
        </div>
