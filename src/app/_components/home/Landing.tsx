  ...
  return (
    <>
      ...
      <section
        ...
        data-oid="x42x5v4"
      >
        <div className="container relative z-10" data-oid="ekz4ijt">
          <div className="flex flex-wrap justify-center" data-oid="ofey:-g">
            <div className="flex w-full px-4 text-center" data-oid="y6miy0n">
              <div
              ...
              >
                ...
                <Typing data-oid="0c_rjfj" />
                <div className="w-2/3" data-oid="e16057x">
                  <p
