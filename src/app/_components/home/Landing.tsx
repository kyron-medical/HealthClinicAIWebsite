  ...
  return (
    <>
      ...
      <section
        ...
        data-oid="slw9gyk"
      >
        <div className="container relative z-10" data-oid="4zi8203">
          <div className="flex flex-wrap justify-center" data-oid="l1k1w:v">
            <div className="flex w-full px-4 text-center" data-oid="tip39c0">
              <div
              ...
              >
                ...
                <Typing data-oid="atoj43p" />
                <div className="w-2/3" data-oid="r:x21te">
                  <p
