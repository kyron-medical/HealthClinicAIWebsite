...
export const metadata: Metadata = {
  ...
  description: "Blog Details Page for Kyron",
  // other metadata
};
  ...
  return (
    <>
      <section
        ...
        data-oid="s_u-5i6"
      >
        <div className="container" data-oid="c.runh8">
          <div className="-mx-4 flex flex-wrap" data-oid="6aps__k">
            <div className="w-full px-4 lg:w-8/12" data-oid="avdkzf5">
              <div data-oid="mqty_58">
                <h1
                ...
                >
                  ...
                  >
                    <div
                      ...
                      data-oid="ij:5kiu"
                    >
                      <div className="mr-4" data-oid="xnyvjv3">
                        <div
                      ...
                      <div className="w-full" data-oid="5933jao">
                        <span
                          className="mb-1 text-base font-medium text-body-color"
                          data-oid="s.roxj-"
                        >
                          By <span data-oid="g8gvcbd"> Musharof Chy</span>
                        </span>
                      </div>
                    </div>
                    <div className="mb-5 flex items-center" data-oid="6bwscav">
                      <p
                        className="mr-5 flex items-center text-base font-medium text-body-color"
                        data-oid="0_6hsvh"
                      >
                        <span className="mr-3" data-oid="u1ai-ua">
                          <svg
                            width="15"
                            height="15"
                            viewBox="0 0 15 15"
                      ...
                      <p
                        ...
                        data-oid="v5gtdni"
                      >
                        <span className="mr-3" data-oid="vx:d460">
                          <svg
                            width="18"
                            height="13"
                            viewBox="0 0 18 13"
                      ...
                      <p
                        ...
                        data-oid="ptm25s2"
                      >
                        <span className="mr-3" data-oid="fwi245s">
                          <svg
                            width="20"
                            height="12"
                            viewBox="0 0 20 12"
                  ...
                  <div className="mb-5" data-oid="80y5kfk">
                    <a
                      href="#0"
                ...
                <div data-oid="x7itcb6">
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <g mask="url(#mask0_111:596)" data-oid="v_f6zlv">
                          <circle
                            opacity="0.8"
                            cx="37.5"
                            cy="37.5"
                        ...
                        <defs data-oid="slz.ll7">
                          ...
                          <radialGradient
                            ...
                            data-oid="j8c0x:b"
                          >
                            <stop stopOpacity="0.47" data-oid="st6:oz7" />
                            <stop
                              offset="1"
                              stopOpacity="0"
                              data-oid="r4ffitw"
                  ...
                  <div
                    ...
                    data-oid="gnn1m3c"
                  >
                    <div className="mb-5" data-oid="y1_k_n7">
                      <h4
                      ...
                      <div className="flex items-center" data-oid="lv3det5">
                        <TagButton text="Design" data-oid="uyskm.x" />
                        <TagButton text="Development" data-oid="zcw13q-" />
                        <TagButton text="Info" data-oid="vmtp7et" />
                      </div>
                    </div>
                    <div className="mb-5" data-oid=":chmt_.">
                      <h5
            ...
            <div className="w-full px-4 lg:w-4/12" data-oid="5wu0f2e">
              <div
              ...
              >
                ...
                <ul className="p-8" data-oid="bnktahv">
                  <li
              ...
              >
                ...
                <ul className="px-8 py-6" data-oid="1ezl:oz">
                  <li data-oid="yy27dv.">
                    <a
                      href="#0"
              ...
              >
                ...
                <div className="flex flex-wrap px-8 py-6" data-oid="wwmgx.1">
                  <TagButton text="Themes" data-oid="v:05frn" />
                  <TagButton text="UI Kit" data-oid="hjc8jmn" />
                  <TagButton text="Tailwind" data-oid="rj9udlq" />
                  <TagButton text="Startup" data-oid="73fvz1v" />
                  <TagButton text="Business" data-oid="3krx1iz" />
                </div>
              </div>

              <NewsLatterBox data-oid="q.y1pm7" />
            </div>
          </div>
        </div>
      </section>
