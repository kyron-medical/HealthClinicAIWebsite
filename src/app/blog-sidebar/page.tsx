  ...
  return (
    <>
      <section
        ...
        data-oid="iztapci"
      >
        <div className="container" data-oid="55.dz11">
          <div className="-mx-4 flex flex-wrap" data-oid="70qjo:y">
            <div className="w-full px-4 lg:w-8/12" data-oid="s.mdy4f">
              <div data-oid="q9z9urf">
                <h1
                ...
                >
                  ...
                  >
                    <div
                      ...
                      data-oid="8kftg-r"
                    >
                      <div className="mr-4" data-oid="sty3wx0">
                        <div
                      ...
                      <div className="w-full" data-oid="kdftyun">
                        <span
                          className="mb-1 text-base font-medium text-body-color"
                          data-oid="980texl"
                        >
                          By <span data-oid="zwm4132"> Musharof Chy</span>
                        </span>
                      </div>
                    </div>
                    <div className="mb-5 flex items-center" data-oid="xluxn5b">
                      <p
                        className="mr-5 flex items-center text-base font-medium text-body-color"
                        data-oid="l.8asy_"
                      >
                        <span className="mr-3" data-oid="cocq:a6">
                          <svg
                            width="15"
                            height="15"
                            viewBox="0 0 15 15"
                      ...
                      <p
                        ...
                        data-oid="d57h1rn"
                      >
                        <span className="mr-3" data-oid="8mlra3u">
                          <svg
                            width="18"
                            height="13"
                            viewBox="0 0 18 13"
                      ...
                      <p
                        ...
                        data-oid="-ob-uu7"
                      >
                        <span className="mr-3" data-oid="dj5b_aj">
                          <svg
                            width="20"
                            height="12"
                            viewBox="0 0 20 12"
                  ...
                  <div className="mb-5" data-oid=":ohmcu_">
                    <a
                      href="#0"
                ...
                <div data-oid="6hkpc_v">
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <g mask="url(#mask0_111:596)" data-oid="pucm2zh">
                          <circle
                            opacity="0.8"
                            cx="37.5"
                            cy="37.5"
                        ...
                        <defs data-oid="ablotgk">
                          ...
                          <radialGradient
                            ...
                            data-oid=":jvv5l9"
                          >
                            <stop stopOpacity="0.47" data-oid="nazywpk" />
                            <stop
                              offset="1"
                              stopOpacity="0"
                              data-oid="m8mt89n"
                  ...
                  <div
                    ...
                    data-oid="3_s5wvd"
                  >
                    <div className="mb-5" data-oid="jp1og2.">
                      <h4
                      ...
                      <div className="flex items-center" data-oid="-dpv4ox">
                        <TagButton text="Design" data-oid="zxoguq." />
                        <TagButton text="Development" data-oid="uvef_gj" />
                        <TagButton text="Info" data-oid="_1jw2x5" />
                      </div>
                    </div>
                    <div className="mb-5" data-oid="gvvm:jw">
                      <h5
            ...
            <div className="w-full px-4 lg:w-4/12" data-oid="s9v.w3z">
              <div
              ...
              >
                ...
                <ul className="p-8" data-oid="siqcin4">
                  <li
              ...
              >
                ...
                <ul className="px-8 py-6" data-oid="8p.3wo_">
                  <li data-oid="ixjr96n">
                    <a
                      href="#0"
              ...
              >
                ...
                <div className="flex flex-wrap px-8 py-6" data-oid="kjg.x9_">
                  <TagButton text="Themes" data-oid="d8q0u1_" />
                  <TagButton text="UI Kit" data-oid="9gu2ud." />
                  <TagButton text="Tailwind" data-oid="udeo0e5" />
                  <TagButton text="Startup" data-oid="r0ecy8t" />
                  <TagButton text="Business" data-oid="7m9o.tx" />
                </div>
              </div>

              <NewsLatterBox data-oid="7w154-x" />
            </div>
          </div>
        </div>
      </section>
