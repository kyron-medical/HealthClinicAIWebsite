  ...
  return (
    <>
      <section
        ...
        data-oid="mw2:0vw"
      >
        <div className="container" data-oid="4vwm1z:">
          <div className="-mx-4 flex flex-wrap" data-oid="sau9s0y">
            <div className="w-full px-4 lg:w-8/12" data-oid="2ixa7-q">
              <div data-oid="gat-:ld">
                <h1
                ...
                >
                  ...
                  >
                    <div
                      ...
                      data-oid="bq-yi_w"
                    >
                      <div className="mr-4" data-oid="_v04jcq">
                        <div
                      ...
                      <div className="w-full" data-oid="3q_-wie">
                        <span
                          className="mb-1 text-base font-medium text-body-color"
                          data-oid="pb46see"
                        >
                          By <span data-oid="d8egbhc"> Musharof Chy</span>
                        </span>
                      </div>
                    </div>
                    <div className="mb-5 flex items-center" data-oid=".rcpvhn">
                      <p
                        className="mr-5 flex items-center text-base font-medium text-body-color"
                        data-oid="vaki-86"
                      >
                        <span className="mr-3" data-oid="z0me74f">
                          <svg
                            width="15"
                            height="15"
                            viewBox="0 0 15 15"
                      ...
                      <p
                        ...
                        data-oid="nyy4bjv"
                      >
                        <span className="mr-3" data-oid="3ly0ytq">
                          <svg
                            width="18"
                            height="13"
                            viewBox="0 0 18 13"
                      ...
                      <p
                        ...
                        data-oid="agw3m.8"
                      >
                        <span className="mr-3" data-oid="i6.997h">
                          <svg
                            width="20"
                            height="12"
                            viewBox="0 0 20 12"
                  ...
                  <div className="mb-5" data-oid="fgynns8">
                    <a
                      href="#0"
                ...
                <div data-oid="kuva5ph">
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <g mask="url(#mask0_111:596)" data-oid="ee3.m44">
                          <circle
                            opacity="0.8"
                            cx="37.5"
                            cy="37.5"
                        ...
                        <defs data-oid="xiqcn-s">
                          ...
                          <radialGradient
                            ...
                            data-oid="07r7iqe"
                          >
                            <stop stopOpacity="0.47" data-oid="1zvreca" />
                            <stop
                              offset="1"
                              stopOpacity="0"
                              data-oid="7udm-2a"
                  ...
                  <div
                    ...
                    data-oid="o-6elo1"
                  >
                    <div className="mb-5" data-oid="e.l44jf">
                      <h4
                      ...
                      <div className="flex items-center" data-oid="6woda_q">
                        <TagButton text="Design" data-oid="odxsup-" />
                        <TagButton text="Development" data-oid="vsx.wlq" />
                        <TagButton text="Info" data-oid="4w1n.xz" />
                      </div>
                    </div>
                    <div className="mb-5" data-oid="6gnw:nf">
                      <h5
            ...
            <div className="w-full px-4 lg:w-4/12" data-oid="nfrk-0-">
              <div
              ...
              >
                ...
                <ul className="p-8" data-oid="_:ct0z5">
                  <li
              ...
              >
                ...
                <ul className="px-8 py-6" data-oid="sfj-sth">
                  <li data-oid="ja6uv3k">
                    <a
                      href="#0"
              ...
              >
                ...
                <div className="flex flex-wrap px-8 py-6" data-oid="1izna8e">
                  <TagButton text="Themes" data-oid=".3h55pf" />
                  <TagButton text="UI Kit" data-oid="m8uer96" />
                  <TagButton text="Tailwind" data-oid="ux4.rzr" />
                  <TagButton text="Startup" data-oid="lnboboo" />
                  <TagButton text="Business" data-oid="be1v-09" />
                </div>
              </div>

              <NewsLatterBox data-oid="50gpxqz" />
            </div>
          </div>
        </div>
      </section>
