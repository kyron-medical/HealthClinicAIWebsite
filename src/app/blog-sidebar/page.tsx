  ...
  return (
    <>
      <section
        ...
        data-oid="wwg9eoa"
      >
        <div className="container" data-oid="55zecjd">
          <div className="-mx-4 flex flex-wrap" data-oid="r8l5lzl">
            <div className="w-full px-4 lg:w-8/12" data-oid="6i5vi3g">
              <div data-oid="nv65:g8">
                <h1
                ...
                >
                  ...
                  >
                    <div
                      ...
                      data-oid="yzlqw1c"
                    >
                      <div className="mr-4" data-oid="c6o3xcn">
                        <div
                      ...
                      <div className="w-full" data-oid="--mi6bf">
                        <span
                          className="mb-1 text-base font-medium text-body-color"
                          data-oid="j5v:v:j"
                        >
                          By <span data-oid="-z-r783"> Musharof Chy</span>
                        </span>
                      </div>
                    </div>
                    <div className="mb-5 flex items-center" data-oid="2:8f5b-">
                      <p
                        className="mr-5 flex items-center text-base font-medium text-body-color"
                        data-oid="wzut7n6"
                      >
                        <span className="mr-3" data-oid="kgzm3x7">
                          <svg
                            width="15"
                            height="15"
                            viewBox="0 0 15 15"
                      ...
                      <p
                        ...
                        data-oid="uq_0r-2"
                      >
                        <span className="mr-3" data-oid="my5b30c">
                          <svg
                            width="18"
                            height="13"
                            viewBox="0 0 18 13"
                      ...
                      <p
                        ...
                        data-oid="3qgwul0"
                      >
                        <span className="mr-3" data-oid="yxtxgtb">
                          <svg
                            width="20"
                            height="12"
                            viewBox="0 0 20 12"
                  ...
                  <div className="mb-5" data-oid="cs6nrmg">
                    <a
                      href="#0"
                ...
                <div data-oid="4vrf660">
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <g mask="url(#mask0_111:596)" data-oid="_a::flj">
                          <circle
                            opacity="0.8"
                            cx="37.5"
                            cy="37.5"
                        ...
                        <defs data-oid="x7xynqu">
                          ...
                          <radialGradient
                            ...
                            data-oid="gg.r8tu"
                          >
                            <stop stopOpacity="0.47" data-oid="wm.e9sp" />
                            <stop
                              offset="1"
                              stopOpacity="0"
                              data-oid="9f2y.-b"
                  ...
                  <div
                    ...
                    data-oid="5._c0gg"
                  >
                    <div className="mb-5" data-oid="r8xnlqz">
                      <h4
                      ...
                      <div className="flex items-center" data-oid="l11hmd4">
                        <TagButton text="Design" data-oid="qj:52h9" />
                        <TagButton text="Development" data-oid="hodx4j2" />
                        <TagButton text="Info" data-oid="_x732lh" />
                      </div>
                    </div>
                    <div className="mb-5" data-oid=":ptxuq4">
                      <h5
            ...
            <div className="w-full px-4 lg:w-4/12" data-oid="hc0in48">
              <div
              ...
              >
                ...
                <ul className="p-8" data-oid="pbd88ke">
                  <li
              ...
              >
                ...
                <ul className="px-8 py-6" data-oid="k3vwc_k">
                  <li data-oid="3tkj0q5">
                    <a
                      href="#0"
              ...
              >
                ...
                <div className="flex flex-wrap px-8 py-6" data-oid="lua1tlh">
                  <TagButton text="Themes" data-oid="yplqg-8" />
                  <TagButton text="UI Kit" data-oid="utqyf7t" />
                  <TagButton text="Tailwind" data-oid="f0ugujf" />
                  <TagButton text="Startup" data-oid="tg0:93x" />
                  <TagButton text="Business" data-oid="cbu1g.n" />
                </div>
              </div>

              <NewsLatterBox data-oid="kwwhkon" />
            </div>
          </div>
        </div>
      </section>
