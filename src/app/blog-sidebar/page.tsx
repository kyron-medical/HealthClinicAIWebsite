  ...
  return (
    <>
      <section
        ...
        data-oid="-pa:02x"
      >
        <div className="container" data-oid="7d0eba2">
          <div className="-mx-4 flex flex-wrap" data-oid="jycg9e1">
            <div className="w-full px-4 lg:w-8/12" data-oid="a5r9xt9">
              <div data-oid="s1i:v3f">
                <h1
                ...
                >
                  ...
                  >
                    <div
                      ...
                      data-oid="omaxk5a"
                    >
                      <div className="mr-4" data-oid="rqk.kk3">
                        <div
                      ...
                      <div className="w-full" data-oid="o5modta">
                        <span
                          className="mb-1 text-base font-medium text-body-color"
                          data-oid="2wt_8ly"
                        >
                          By <span data-oid="ufpnpqs"> Musharof Chy</span>
                        </span>
                      </div>
                    </div>
                    <div className="mb-5 flex items-center" data-oid="gt-2l8a">
                      <p
                        className="mr-5 flex items-center text-base font-medium text-body-color"
                        data-oid=".ffi:ie"
                      >
                        <span className="mr-3" data-oid="blb-0up">
                          <svg
                            width="15"
                            height="15"
                            viewBox="0 0 15 15"
                      ...
                      <p
                        ...
                        data-oid="3g56-c_"
                      >
                        <span className="mr-3" data-oid="93q76yb">
                          <svg
                            width="18"
                            height="13"
                            viewBox="0 0 18 13"
                      ...
                      <p
                        ...
                        data-oid="pydea_2"
                      >
                        <span className="mr-3" data-oid="sx10akg">
                          <svg
                            width="20"
                            height="12"
                            viewBox="0 0 20 12"
                  ...
                  <div className="mb-5" data-oid="p.1:-jw">
                    <a
                      href="#0"
                ...
                <div data-oid="6.9bcs2">
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <g mask="url(#mask0_111:596)" data-oid="nz7mc_8">
                          <circle
                            opacity="0.8"
                            cx="37.5"
                            cy="37.5"
                        ...
                        <defs data-oid="zri:l:h">
                          ...
                          <radialGradient
                            ...
                            data-oid="6-xnl7t"
                          >
                            <stop stopOpacity="0.47" data-oid="ly0mzxg" />
                            <stop
                              offset="1"
                              stopOpacity="0"
                              data-oid="c_vlgbz"
                  ...
                  <div
                    ...
                    data-oid="gdi30us"
                  >
                    <div className="mb-5" data-oid="oj0e5vr">
                      <h4
                      ...
                      <div className="flex items-center" data-oid="ad_2sl_">
                        <TagButton text="Design" data-oid="teu9_9t" />
                        <TagButton text="Development" data-oid="xcfeik6" />
                        <TagButton text="Info" data-oid="unw1nol" />
                      </div>
                    </div>
                    <div className="mb-5" data-oid="kkh89cb">
                      <h5
            ...
            <div className="w-full px-4 lg:w-4/12" data-oid="u251zet">
              <div
              ...
              >
                ...
                <ul className="p-8" data-oid="o998vm6">
                  <li
              ...
              >
                ...
                <ul className="px-8 py-6" data-oid=":1w95qp">
                  <li data-oid="5hxkiai">
                    <a
                      href="#0"
              ...
              >
                ...
                <div className="flex flex-wrap px-8 py-6" data-oid="fzpdu98">
                  <TagButton text="Themes" data-oid="_oban5i" />
                  <TagButton text="UI Kit" data-oid="9_fg9l3" />
                  <TagButton text="Tailwind" data-oid=".c8nz09" />
                  <TagButton text="Startup" data-oid="la7ml4_" />
                  <TagButton text="Business" data-oid="ku5g_c_" />
                </div>
              </div>

              <NewsLatterBox data-oid="y-lv87x" />
            </div>
          </div>
        </div>
      </section>
